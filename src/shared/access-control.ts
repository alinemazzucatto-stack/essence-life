...
export type AppPage = 'home' | 'sleep' | 'nutrition' | 'house' | 'agenda' | 'finance' | 'cycle' | 'routine' | 'diary' | 'workouts' | 'profile';
...
const requiredPlanByPage: Record<GatedPage, SubscriptionPlan> = { agenda: 'free', routine: 'free', diary: 'essential', sleep: 'essential', nutrition: 'premium', workouts: 'premium', cycle: 'essential', finance: 'premium', house: 'premium' };
...
export const pageMeta: Record<AppPage, { title: string; copy: string }> = {
  ...
  diary: { title: '📔 Diário', copy: 'Registre sentimentos e pensamentos.' }, workouts: { title: '🏋️ Treinos', copy: 'Monte seus treinos e acompanhe a evolução.' },
