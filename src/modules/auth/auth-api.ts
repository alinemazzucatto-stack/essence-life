...
const DEVELOPER_EMAILS=new Set(['alinelima364@outlook.com']);
export const isDeveloperEmail=(email:string)=>DEVELOPER_EMAILS.has(email.trim().toLowerCase());
